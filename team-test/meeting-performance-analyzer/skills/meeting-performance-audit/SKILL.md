...
- **Preferences file** at `<workspace>/client-profile/meeting-preferences.md` — written by `extract-meeting-preferences`. Required.
...
2. Read `<workspace>/client-profile/meeting-preferences.md`. If absent → halt with: *"No meeting preferences found. Run `extract-meeting-preferences` first."*
